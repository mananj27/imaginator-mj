            ...
            .then((url) => {
              if (prompt !== '') {
                addDoc(postRef, {
                  ...
                  .then((res) => alert('Your Art-work has been posted'))
    ...
    <div className="imageGen">
      ...
      <form className="generate-form mt-2" onSubmit={handleSubmit}>
        <input
          ...
          onChange={(e) => setPrompt(e.target.var)}
        />
      ...
      {!loading && output && (
        <div className="result-image">
          ...
          <div className="action">
            <button onClick={handleDownload} className="download-button" title="Download Art">
              <FileDownloadIcon />
            </button>
            {user && (
              <button onClick={uploadImage} className="share-button" title="Share Art">
                <ShareIcon />
              </button>
            )}
          </div>
